...
/*	$Header: rotate.c,v 4.1 88/08/24 14:39:17 bianchi Exp $
	$Source: /tmp/mgrsrc/misc/RCS/rotate.c,v $
*/
static char	RCSid_[] = "$Source: /tmp/mgrsrc/misc/RCS/rotate.c,v $$Revision: 4.1 $";

#include <stdio.h>
#include "dump.h"

#define MAX	4800		/* max bitmap size */
