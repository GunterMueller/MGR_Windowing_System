 ...
 */
/*	$Header: many.c,v 4.1 88/06/21 14:02:06 bianchi Exp $
	$Source: /tmp/mgrsrc/demo/tests/RCS/many.c,v $
*/
static char	RCSid_[] = "$Source: /tmp/mgrsrc/demo/tests/RCS/many.c,v $$Revision: 4.1 $";
