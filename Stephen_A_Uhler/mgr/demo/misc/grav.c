 ...
 */
/*	$Header: grav.c,v 4.3 88/06/30 11:41:44 sau Exp $
	$Source: /tmp/mgrsrc/demo/misc/RCS/grav.c,v $
*/
static char	RCSid_[] = "$Source: /tmp/mgrsrc/demo/misc/RCS/grav.c,v $$Revision: 4.3 $";
