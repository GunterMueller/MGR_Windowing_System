 ...
 */
/*	$Header: window_print.c,v 4.1 88/06/21 14:00:15 bianchi Exp $
	$Source: /tmp/mgrsrc/demo/icon/RCS/window_print.c,v $
*/
static char	RCSid_[] = "$Source: /tmp/mgrsrc/demo/icon/RCS/window_print.c,v $$Revision: 4.1 $";
...
char **argv;
   ...
   m_setevent(ACTIVATED,"A\r");			/* window made active */
   m_setevent(DEACTIVATED,"D\r");		/* window made in-avtive */
   m_setevent(BUTTON_1,"B %w\r");		/* button 1 hit */
