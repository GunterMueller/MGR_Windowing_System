...
u_short oldmode;		/* protection bits of the tty when the
				   program started */
...
#   define BUFLEN (80)
    ...
    /* clicked on a window */
    m_setevent(BUTTON_1, "\005b%p,%n\\r");

    /* screen is being redrawn */
    m_setevent(REDRAW, "\005r\\r");

    /* window was reshaped */
    m_setevent(RESHAPE, "\005s\\r");

    /* a window is done with being opened - rebuild the menu */
    m_setevent(ACCEPT, "\005n\\r");
   ...
   the name of the ptty running the window. */
{
    ...
    static char topevents[] = ",\005q\\r,\005n\\r,";
