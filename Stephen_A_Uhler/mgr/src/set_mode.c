 ...
 */
/*	$Header: /home/sau/mgr/src/RCS/set_mode.c,v 1.2 91/02/11 09:48:03 sau Exp Locker: sau $
	$Source: /home/sau/mgr/src/RCS/set_mode.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/src/RCS/set_mode.c,v $$Revision: 1.2 $";

/* muck with tty modes */

#include <fcntl.h>
#include <sgtty.h>
#include <sys/time.h>						/* needed for sundev/vuid_event.h> */
...
int file;				/* file descriptor */
   ...
   fcntl(file,F_SETFL,fcntl(file,F_GETFL,0)|FNDELAY); /* for 4.1 */
  	ioctl(file,VUIDSFORMAT,0);    /* set normal mode (X leaves it broken) */
