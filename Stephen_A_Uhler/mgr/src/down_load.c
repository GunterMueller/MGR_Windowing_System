 ...
 */
/*	$Header: /home/sau/mgr/src/RCS/down_load.c,v 1.2 91/02/11 09:46:49 sau Exp Locker: sau $
	$Source: /home/sau/mgr/src/RCS/down_load.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/src/RCS/down_load.c,v $$Revision: 1.2 $";
...
BITMAP *window, *text;
         ...
         case T_MENU:				/* down load menu */
                ...
                if (*W(snarf)) {
                   W(menus)[*W(esc)] = do_menu(W(snarf),f,
                           PUTCOLOR(W(style)),PUTCOLOR(W(background)));
		   if( active == win ) {
   ...
   W(snarf) = (char *) 0;				/* sau 7/91 (I missed one somewhere) */
   }
