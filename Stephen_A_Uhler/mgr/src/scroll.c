 ...
 */
/*	$Header: /home/sau/mgr/src/RCS/scroll.c,v 1.1 91/02/11 09:48:01 sau Exp Locker: sau $
	$Source: /home/sau/mgr/src/RCS/scroll.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/src/RCS/scroll.c,v $$Revision: 1.1 $";
...
#endif ALIGN
            bit_blit(map,0,start,BIT_WIDE(map),ems-delta,
                   BIT_SRC,map,0,start+delta);
      bit_blit(map,0,end-delta,BIT_WIDE(map),delta,op,NULL_DATA,0,0);
      }
