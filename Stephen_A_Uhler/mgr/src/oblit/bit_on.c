 ...
 */
/*	$Header: bit_on.c,v 1.2 88/07/20 14:17:51 sau Exp $
	$Source: /tmp/mgrsrc/src/oblit/RCS/bit_on.c,v $
*/
static char	RCSid_[] = "$Source: /tmp/mgrsrc/src/oblit/RCS/bit_on.c,v $$Revision: 1.2 $";
