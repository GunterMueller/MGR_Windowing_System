 ...
 */
/*	$Header: /home/sau/mgr/src/RCS/graph_subs.c,v 1.1 91/02/11 09:47:28 sau Exp Locker: sau $
	$Source: /home/sau/mgr/src/RCS/graph_subs.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/src/RCS/graph_subs.c,v $$Revision: 1.1 $";
...
int f;
   ...
   if(a==0 || b==0)
      ...
      ellip1(screen, x, y, a, b, bit_point, 0, b, 0, b, f);
   }
 ...
 * from x1,y1 to x2,y2
 * do "action" at each point
 */

ellip1(screen, x0,y0, a, b, action, x1,y1, x2,y2, f)
