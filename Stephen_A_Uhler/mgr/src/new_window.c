 ...
 */
/*	$Header: /home/sau/mgr/src/RCS/new_window.c,v 1.2 91/02/11 09:47:47 sau Exp Locker: sau $
	$Source: /home/sau/mgr/src/RCS/new_window.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/src/RCS/new_window.c,v $$Revision: 1.2 $";
...
#endif
#ifdef COLOR
   W(background) = NOCOLOR&BIT_SRC | GETCOLOR(WHITE);
   W(style) = NOCOLOR&BIT_SRC | GETCOLOR(BLACK);
#else
   W(style) = OPCODE(BIT_SRC);
   W(background) = OPCODE(BIT_CLR);
#endif
