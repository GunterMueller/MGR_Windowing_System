 ...
 */
/*	$Header: /home/sau/mgr/src/RCS/getshell.c,v 1.1 91/02/11 09:47:26 sau Exp Locker: sau $
	$Source: /home/sau/mgr/src/RCS/getshell.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/src/RCS/getshell.c,v $$Revision: 1.1 $";
...
int *file;
   ...
   if (name == (char *) 0 || *name == '\0') {
		perror("no command to run in the window");
      return(-2);
		}
