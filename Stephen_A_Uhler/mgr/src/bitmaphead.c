 ...
 */
/*	$Header: /home/sau/mgr/src/RCS/bitmaphead.c,v 1.2 91/02/11 09:46:11 sau Exp Locker: sau $
	$Source: /home/sau/mgr/src/RCS/bitmaphead.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/src/RCS/bitmaphead.c,v $$Revision: 1.2 $";
...
int	*wp, *hp, *dp, *size1p;
{
	...
	if( fread( (char *)&head, B_OHSIZE, 1, fp ) != 1 )
		return  0;
	...
	if( B_ISHDR8( &head ) ) {	/* modern, self-describing
		...
		if( fread( &head.depth, sizeof head - B_OHSIZE, 1, fp ) != 1 )
			return  0;
