 ...
 */
/*	$Header: /home/sau/mgr/src/RCS/win_stack.c,v 1.1 91/02/11 09:48:19 sau Exp Locker: sau $
	$Source: /home/sau/mgr/src/RCS/win_stack.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/src/RCS/win_stack.c,v $$Revision: 1.1 $";
      ...
      switch (level&i) {
         ...
         case P_FLAGS:		/* save window flags  */
              if (level&P_CLEAR) {
                 ...
                 W(background) = NOCOLOR&W(background) | GETCOLOR(WHITE);
                 if (win == active)
