 ...
 */
/*	$Header: do_buckey.c,v 1.1 89/03/17 08:21:03 sau Exp $
	$Source: /m1/mgr.new/src/RCS/do_buckey.c,v $
*/
static char	RCSid_[] = "$Source: /m1/mgr.new/src/RCS/do_buckey.c,v $$Revision: 1.1 $";
